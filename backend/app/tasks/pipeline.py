...
def process_lecture(self, lecture_id: str):
    ...
    worker). Delegates to _process_lecture_impl and retries on failure."""
    _process_lecture_impl(lecture_id, celery_task=self)


def process_lecture_direct(lecture_id: str):
